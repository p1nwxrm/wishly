...
class UserCompact(BaseModel):
    """
    Safe, minimal user data for public display (e.g., in feeds or lists).
    """
    id: int
    username: str
    name: str
...
class UserProfile(BaseModel):
    """
    Public profile information, safe for displaying to other users.
    Includes social statistics and the current user's relationship to this profile.
    """
    user: UserCompact
